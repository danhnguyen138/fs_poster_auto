...
class Ajax
{
	...
	public function __construct ()
	{
		if ( Helper::canLoadPlugin() )
		{
			...
			{
				if ( $method === '__construct' || $method === 'verifyNonce' )
				{
					continue;
				}
    ...
    private function verifyNonce ()
    {
        ...
        if(!isset($headers['Fs-Nonce']) || !wp_verify_nonce($headers['Fs-Nonce'], 'fs_ajax'))
        {
            Helper::response(false, fsp__('Please, refresh the page and try again.'));
        }
    }
}
