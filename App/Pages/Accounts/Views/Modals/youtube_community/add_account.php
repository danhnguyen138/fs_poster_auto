...
<div class="fsp-modal-body">
    ...
    <div class="fsp-modal-step">
        ...
        <div class="fsp-form-group">
            <label class="fsp-is-jb">
                <?php echo fsp__( 'Enter the cookie' ); ?> __Secure-3PSIDTS
            </label>
            <div class="fsp-form-input-has-icon">
                <i class="fas fa-key"></i>
                <input id="fspCookie_secure3pSidTS" autocomplete="off" class="fsp-form-input" placeholder="<?php echo fsp__( 'Enter the cookie' ); ?> __Secure-3PSIDTS">
            </div>
        </div>
    </div>
