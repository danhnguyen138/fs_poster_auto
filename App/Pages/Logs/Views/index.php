...
<div class="fsp-row">
	...
	<input id="fspFilterSelector" type="hidden" value="<?php echo htmlspecialchars(Request::get('filter_by', 'all')); ?>">
	<input id="fspSnSelector" type="hidden" value="<?php echo htmlspecialchars(Request::get('sn_filter', 'all')); ?>">
