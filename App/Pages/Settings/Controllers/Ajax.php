	...
	public function settings_facebook_save ()
	{
		...
		if ( ! empty( $fs_facebook_story_custom_font[ 'name' ] ) )
		{
			if ( pathinfo( $fs_facebook_story_custom_font[ 'name' ], PATHINFO_EXTENSION ) === 'ttf' )
			{
                ...
                if(!file_exists(wp_upload_dir()[ 'basedir' ] . '/fs-poster-fonts'))
                {
                    $dirExists = mkdir(wp_upload_dir()[ 'basedir' ] . '/fs-poster-fonts');
                }
                ...
                if($dirExists)
                {
                    ...
                    file_put_contents( $custom_font_file_path, file_get_contents($fs_facebook_story_custom_font[ 'tmp_name' ]));

                    if(file_exists($fs_facebook_story_custom_font[ 'tmp_name' ])){
                        unlink($fs_facebook_story_custom_font[ 'tmp_name' ]);
                    }
		...
		if ( ! empty( $fs_instagram_story_custom_font[ 'name' ] ) )
		{
			if ( pathinfo( $fs_instagram_story_custom_font[ 'name' ], PATHINFO_EXTENSION ) === 'ttf' )
			{
                ...
                if($dirExists)
                {
                    ...
                    file_put_contents( $custom_font_file_path, file_get_contents($fs_instagram_story_custom_font[ 'tmp_name' ]));

                    if(file_exists($fs_instagram_story_custom_font[ 'tmp_name' ])){
                        unlink($fs_instagram_story_custom_font[ 'tmp_name' ]);
                    }
