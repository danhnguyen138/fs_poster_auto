	...
	private function enqueueAssets ()
	{
		add_action( 'admin_enqueue_scripts', function () {
			...
			wp_localize_script( 'fsp', 'fspConfig', [
				...
				'siteURL'  => site_url(),
                'ajaxNonce' => wp_create_nonce( 'fs_ajax' )
			] );
			...
			wp_enqueue_style( 'fsp-fonts', 'https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,400;0,600;1,400;1,600&display=swap' );
			wp_enqueue_style( 'fsp-fontawesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.0-2/css/all.min.css' );
			wp_enqueue_style( 'fsp-select2', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/css/select2.min.css' );
